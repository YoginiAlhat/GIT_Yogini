...
namespace BenchRockers.Web.Controllers
{
    public class EmployeeSkillsController : Controller
    {
        ...
        public EmployeeSkillsController(IServiceFacade serviceFacade)
        {
        ...
        {
            var employeeskill = _serviceFacade.EmployeeSkillService.GetEmployeeSkills();
                //db.EmployeeSkills.Include(e => e.Employees).Include(e => e.Skills);
        ...
        public JsonResult EmployeeSkillsList(int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            ...
            {
                Thread.Sleep(200);
                var skillCount = _serviceFacade.EmployeeSkillService.GetEmployeeSkills().Count();
        ...
        {
            IEnumerable<EmployeeSkill> query = _serviceFacade.EmployeeSkillService.GetEmployeeSkills().ToList();
